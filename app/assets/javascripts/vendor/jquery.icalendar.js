...
function iCalendar() {
	...
	this._sites = {  // The definitions of the available iCalendar sites
		...
		'yahoo': {display: 'Yahoo', icon: 3, override: yahooOverride,
			...
			'&amp;title={t}&amp;st={s}&amp;dur={p}&amp;desc={d}&amp;in_loc={l}&amp;url={u}&amp'}
...
function yahooOverride(inserts, settings) {
	...
	inserts.s = $.icalendar.formatDateTime(settings.start, true)
	inserts.e = $.icalendar.formatDateTime(settings.end, true)
